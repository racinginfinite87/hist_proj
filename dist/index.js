...
ymaps3.import.loaders.unshift((pkg) => __awaiter(void 0, void 0, void 0, function* () {
    if (!pkg.includes('@yandex/ymaps3-clusterer')) {
        return;
    }
    if (location.href.includes('localhost')) {
        yield ymaps3.import.script(`/dist/index.js`);
    }
    else {
        // You can use another CDN
        yield ymaps3.import.script(`https://unpkg.com/${pkg}/dist/index.js`);
    }
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { YMapClusterer, clusterByGrid } = yield ymaps3.import('@yandex/ymaps3-clusterer');
        ...
        class CustomMarkerWithPopup extends YMapComplexEntity {
            ...
            _openPopup() {
                ...
                img.src = (_a = this._props.imageSource) !== null && _a !== void 0 ? _a : "#";
                img.alt = "image";
                ...
                const zIndex = ((_b = this._props.zIndex) !== null && _b !== void 0 ? _b : YMapMarker.defaultProps.zIndex) + 1000;
